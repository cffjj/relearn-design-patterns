...
public class ApiTest {
    ...
    public void test_awardToUser(){
        ...
        req01.setAwardNumber("EGM1023938910232143535");
        req01.setBizId("791098764902132");
        AwardRes awardRes01 = prizeController.awardToUser(req01);

        logger.info("请求参数：{}", JSON.toJSONString(req01));
        logger.info("测试结果：{}",JSON.toJSONString(awardRes01));
        ...
        req02.setExtMap(new HashMap<String,String>(){{
            put("consigneeUserName","菜菜");
            put("consigneeUserPhone","1580324323");
            put("consigneeUserAddress","广东广州");
        }});
